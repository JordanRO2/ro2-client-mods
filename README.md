...
```bash
python exe/patch_client.py --in <stock Rag2.exe> --out Rag2.exe   # 26 fixes, 312 bytes
...
repository. `python exe/patch_client.py --list` prints the full catalog of all 69 executable
...
| path | what it is |
|---|---|
| `exe/patch_client.py` | the executable fix catalog (69) and byte patcher — self-verifying, pattern-anchored |
