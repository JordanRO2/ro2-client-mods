...
```bash
python exe/patch_client.py --in <stock Rag2.exe> --out Rag2.exe   # 28 fixes, 324 bytes
...
repository. `python exe/patch_client.py --list` prints the full catalog of all 72 executable
...
| path | what it is |
|---|---|
| `exe/patch_client.py` | the executable fix catalog (72) and byte patcher — self-verifying, pattern-anchored |
